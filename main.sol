...
contract MyEtherWorld is ERC721Enumerable, Ownable {

    //VARIABLES
    uint public MEWCap = 1024;
    uint public price = 100000000000000000; //0.1 Ether
    uint public randomPrice = 75000000000000000; //0.075 Ether
    uint lastId;
    string baseTokenURI;
    ...
    function mint() public payable {
        ...
        require(msg.value >= randomPrice, "Ether amount is not correct.");
    ...
    function withdraw() payable public {
        uint memberPart = address(this).balance / 3;
        payable(member1).transfer(memberPart);
        payable(member2).transfer(memberPart);
        payable(member3).transfer(memberPart);
    }
